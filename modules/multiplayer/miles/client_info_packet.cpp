...
int ClientInfoPacket::set_u8_max_command_frame_rate(int u8_max_command_frame_rate) {
	
}
float ClientInfoPacket::get_half_buffer_time() {
	
}
float ClientInfoPacket::set_half_buffer_time(float half_buffer_time) {
	
}
float ClientInfoPacket::get_half_input_buffer_time() {
	
}
float ClientInfoPacket::set_half_input_buffer_time(float half_input_buffer_time) {
	
}
float ClientInfoPacket::get_half_server_input_buffer_time() {
	
}
float ClientInfoPacket::set_half_server_input_buffer_time(float half_server_input_buffer_time) {
	
}
int ClientInfoPacket::get_u32_max_receive_bandwidth() {
	
}
int ClientInfoPacket::set_u32_max_receive_bandwidth(int u32_max_receive_bandwidth) {
	
}
int ClientInfoPacket::get_u32_max_send_bandwidth() {
	
}
int ClientInfoPacket::set_u32_max_send_bandwidth(int u32_max_send_bandwidth) {
