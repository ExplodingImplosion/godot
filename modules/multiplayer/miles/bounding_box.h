...
MeshInstance3d set_mesh(MeshInstance3d mesh);
Array get_states();
Array set_states(Array states);
int get_state_idx();
int set_state_idx(int state_idx);
int get_num_states();
int set_num_states(int num_states);
CollisionShape3d get_collider();
CollisionShape3d set_collider(CollisionShape3d collider);
BoxShape3d get_shape();
BoxShape3d set_shape(BoxShape3d shape);
};
