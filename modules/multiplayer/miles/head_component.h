...
CharacterBody3d set_player(CharacterBody3d player);
Camera3d get_camera();
Camera3d set_camera(Camera3d camera);
RemoteTransform3d get_transformer();
RemoteTransform3d set_transformer(RemoteTransform3d transformer);
Callable get_stick_aim_func();
Callable set_stick_aim_func(Callable stick_aim_func);
Callable get_release_mouse_aim();
Callable set_release_mouse_aim(Callable release_mouse_aim);
Callable get_release_stick_aim();
Callable set_release_stick_aim(Callable release_stick_aim);
};
