...
int WorldStateConfirmationPacket::set_u32_confirmation_frame_num(int u32_confirmation_frame_num) {
...
ADD_PROPERTY(PropertyInfo(Variant::INT, "u32_confirmation_frame_num" , "get_u32_confirmation_frame_num", "set_u32_confirmation_frame_num")); // unfinished and u should prolly change this
}