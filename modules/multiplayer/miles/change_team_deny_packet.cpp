...
int ChangeTeamDenyPacket::set_u8_player_index(int u8_player_index) {
	
}
void ChangeTeamDenyPacket::_bind_methods(){
ClassDB::bind_method(D_METHOD("_execute", "_sender_id"), &ChangeTeamDenyPacket::_execute);
ClassDB::bind_method(D_METHOD("is_script_valid_packet", "script"), &ChangeTeamDenyPacket::is_script_valid_packet);
ClassDB::bind_method(D_METHOD("_execute", "_sender_id"), &ChangeTeamDenyPacket::_execute);
