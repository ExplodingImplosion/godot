...
int WorldStatePacket::set_u32_frame(int p_u32_frame) {
	
}
int WorldStatePacket::get_u32_last_frame() {
	
}
int WorldStatePacket::set_u32_last_frame(int p_u32_last_frame) {
	
}
int WorldStatePacket::get_u32_input_signature() {
	
}
int WorldStatePacket::set_u32_input_signature(int p_u32_input_signature) {
	
}
int WorldStatePacket::get_u32_acked_signature() {
	
}
int WorldStatePacket::set_u32_acked_signature(int p_u32_acked_signature) {
	
}
PackedByteArray WorldStatePacket::get_contents() {
	
}
PackedByteArray WorldStatePacket::set_contents(PackedByteArray p_contents) {
