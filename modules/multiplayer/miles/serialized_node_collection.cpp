...
Ref<SerializedNodeCollection>::create_fresh(uint32_t uid, uint32_t scene_id, uint32_t owner_id, uint64_t team, uint32_t frame_created, Array node_configs) {
	
}
void SerializedNodeCollection::_init(Array property_lists, uint32_t uid, uint32_t scene_id, uint32_t owner_id, uint64_t team, uint32_t frame_created, Array node_configs, bool duplicate) {
	
}
void SerializedNodeCollection::encode_spawn(StreamPeerBuffer buffer, VisibilityType vis_type) {
	
}
void SerializedNodeCollection::decode_spawn(StreamPeerBuffer buffer, VisibilityType vis_type) {
	
}
void SerializedNodeCollection::encode_delta(RefCounted prev, StreamPeerBuffer buffer, VisibilityType vis_type) {
	
}
void SerializedNodeCollection::decode_delta(StreamPeerBuffer buffer, VisibilityType vis_type) {
...
void SerializedNodeCollection::_bind_methods(){
    ...
    ADD_PROPERTY(PropertyInfo(Variant::ARRAY, "node_configs"), "set_node_configs," "get_node_configs"); // unfinished and u should prolly change this
    ...
    ADD_PROPERTY(PropertyInfo(Variant::ARRAY, "property_lists"), "set_property_lists," "get_property_lists"); // unfinished and u should prolly change this
    ...
    ADD_PROPERTY(PropertyInfo(Variant::ARRAY, "prev_property_lists"), "set_prev_property_lists," "get_prev_property_lists"); // unfinished and u should prolly change this
