...
int get_player_id();
int set_player_id(int p_player_id);
Array get_requesters();
Array set_requesters(Array p_requesters);
Array get_callables();
Array set_callables(Array p_callables);
Dictionary get_bounding_boxes();
Dictionary set_bounding_boxes(Dictionary p_bounding_boxes);
bool get_subtick();
bool set_subtick(bool p_subtick);
};
