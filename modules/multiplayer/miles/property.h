...
StringName get_name();
StringName set_name(StringName name);
int get_type();
int set_type(int type);
int get_precision_level();
int set_precision_level(int precision_level);
int get_sub_property_index();
int set_sub_property_index(int sub_property_index);
int get_interp_type();
int set_interp_type(int interp_type);
int get_visibility_type();
int set_visibility_type(int visibility_type);
bool get_physical();
bool set_physical(bool physical);
bool get_rotation();
bool set_rotation(bool rotation);
bool get_recent_only();
bool set_recent_only(bool recent_only);
int get_network_type();
int set_network_type(int network_type);
int get_max_bits();
int set_max_bits(int max_bits);
int get_size_bytes();
int set_size_bytes(int size_bytes);
int get_encode_type();
int set_encode_type(int encode_type);
Property get_value_type();
Property set_value_type(Property value_type);
Property get_key_type();
Property set_key_type(Property key_type);
};
