...
static Node get_hit_resolver();
static void set_hit_resolver(Node p_hit_resolver);
Node3D get_mp_level();
void set_mp_level(Node3D p_mp_level);
Array get_hit_requests();
void set_hit_requests(Array p_hit_requests);
Dictionary get_hit_map();
void set_hit_map(Dictionary p_hit_map);
