...
int set_u8_max_command_frame_rate(int p_u8_max_command_frame_rate);
float get_half_buffer_time();
float set_half_buffer_time(float p_half_buffer_time);
float get_half_input_buffer_time();
float set_half_input_buffer_time(float p_half_input_buffer_time);
float get_half_server_input_buffer_time();
float set_half_server_input_buffer_time(float p_half_server_input_buffer_time);
int get_u32_max_receive_bandwidth();
int set_u32_max_receive_bandwidth(int p_u32_max_receive_bandwidth);
int get_u32_max_send_bandwidth();
int set_u32_max_send_bandwidth(int p_u32_max_send_bandwidth);
};
