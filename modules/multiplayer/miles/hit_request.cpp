...
int HitRequest::set_player_id(int player_id) {
	
}
Array HitRequest::get_requesters() {
	
}
Array HitRequest::set_requesters(Array requesters) {
	
}
Array HitRequest::get_callables() {
	
}
Array HitRequest::set_callables(Array callables) {
	
}
Dictionary HitRequest::get_bounding_boxes() {
	
}
Dictionary HitRequest::set_bounding_boxes(Dictionary bounding_boxes) {
	
}
bool HitRequest::get_subtick() {
	
}
bool HitRequest::set_subtick(bool subtick) {
...
ADD_PROPERTY(PropertyInfo(Variant::ARRAY, "requesters" , "get_requesters", "set_requesters", 31, "Node", 4096)); // unfinished and u should prolly change this
ADD_PROPERTY(PropertyInfo(Variant::ARRAY, "callables" , "get_callables", "set_callables", 31, "Callable", 4096)); // unfinished and u should prolly change this
ADD_PROPERTY(PropertyInfo(Variant::DICTIONARY, "bounding_boxes" , "get_bounding_boxes", "set_bounding_boxes", 38, "StaticBody3D;Variant", 4096)); // unfinished and u should prolly change this
