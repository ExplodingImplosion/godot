...
GdScript set_packet_class(GdScript p_packet_class);
int get_id();
int set_id(int p_id);
NetworkedNode get_property_list();
NetworkedNode set_property_list(NetworkedNode p_property_list);
int get_receivable_by();
int set_receivable_by(int p_receivable_by);
bool get_compressable();
bool set_compressable(bool p_compressable);
int get_send_mode();
int set_send_mode(int p_send_mode);
};
