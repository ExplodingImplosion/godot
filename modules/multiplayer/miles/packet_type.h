...
GdScript set_packet_class(GdScript packet_class);
int get_id();
int set_id(int id);
NetworkedNode get_property_list();
NetworkedNode set_property_list(NetworkedNode property_list);
int get_receivable_by();
int set_receivable_by(int receivable_by);
bool get_compressable();
bool set_compressable(bool compressable);
int get_send_mode();
int set_send_mode(int send_mode);
};
