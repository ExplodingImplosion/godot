...
int set_id(int id);
Array get_players();
Array set_players(Array players);
bool get_ready();
bool set_ready(bool ready);
RefCounted get_most_recent_acked_frame();
RefCounted set_most_recent_acked_frame(RefCounted most_recent_acked_frame);
RefCounted get_dirty_frame();
RefCounted set_dirty_frame(RefCounted dirty_frame);
int get_server_acked_frame_num();
int set_server_acked_frame_num(int server_acked_frame_num);
int get_last_decoded_frame_size();
int set_last_decoded_frame_size(int last_decoded_frame_size);
int get_team();
int set_team(int team);
RefCounted get_most_recent_received_frame();
RefCounted set_most_recent_received_frame(RefCounted most_recent_received_frame);
int get_input_signature();
int set_input_signature(int input_signature);
int get_acked_input_signature();
int set_acked_input_signature(int acked_input_signature);
int get_server_input_signature();
int set_server_input_signature(int server_input_signature);
int get_input_buffer_offset();
int set_input_buffer_offset(int input_buffer_offset);
RefCounted get_replay();
RefCounted set_replay(RefCounted replay);
bool get_fucked();
bool set_fucked(bool fucked);
Dictionary get_uid_map();
Dictionary set_uid_map(Dictionary uid_map);
int get_max_command_frame_rate();
int set_max_command_frame_rate(int max_command_frame_rate);
float get_buffer_time();
float set_buffer_time(float buffer_time);
float get_input_buffer_time();
float set_input_buffer_time(float input_buffer_time);
float get_server_input_buffer_time();
float set_server_input_buffer_time(float server_input_buffer_time);
int get_max_receive_bandwidth();
int set_max_receive_bandwidth(int max_receive_bandwidth);
int get_max_send_bandwidth();
int set_max_send_bandwidth(int max_send_bandwidth);
};
