...
Array get_players();
void set_players(Array p_players);
bool get_ready();
void set_ready(bool p_ready);
RefCounted get_most_recent_acked_frame();
void set_most_recent_acked_frame(RefCounted p_most_recent_acked_frame);
RefCounted get_dirty_frame();
void set_dirty_frame(RefCounted p_dirty_frame);
int get_server_acked_frame_num();
void set_server_acked_frame_num(int p_server_acked_frame_num);
int get_last_decoded_frame_size();
void set_last_decoded_frame_size(int p_last_decoded_frame_size);
int get_team();
void set_team(int p_team);
RefCounted get_most_recent_received_frame();
void set_most_recent_received_frame(RefCounted p_most_recent_received_frame);
int get_input_signature();
void set_input_signature(int p_input_signature);
int get_acked_input_signature();
void set_acked_input_signature(int p_acked_input_signature);
int get_server_input_signature();
void set_server_input_signature(int p_server_input_signature);
int get_input_buffer_offset();
void set_input_buffer_offset(int p_input_buffer_offset);
RefCounted get_replay();
void set_replay(RefCounted p_replay);
bool get_fucked();
void set_fucked(bool p_fucked);
Dictionary get_uid_map();
void set_uid_map(Dictionary p_uid_map);
int get_max_command_frame_rate();
void set_max_command_frame_rate(int p_max_command_frame_rate);
float get_buffer_time();
void set_buffer_time(float p_buffer_time);
float get_input_buffer_time();
void set_input_buffer_time(float p_input_buffer_time);
float get_server_input_buffer_time();
void set_server_input_buffer_time(float p_server_input_buffer_time);
int get_max_receive_bandwidth();
void set_max_receive_bandwidth(int p_max_receive_bandwidth);
