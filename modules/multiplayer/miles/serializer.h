...
void decode_nodes(StreamPeerBitBuffer buffer);
void delta_decode_nodes(StreamPeerBitBuffer buffer);
...
void set_test_dict(Dictionary p_test_dict);
float get_update_frequency();
void set_update_frequency(float p_update_frequency);
float get_update_time_left();
void set_update_time_left(float p_update_time_left);
bool get_updating();
void set_updating(bool p_updating);
int get_uid();
void set_uid(int p_uid);
int get_scene_id();
void set_scene_id(int p_scene_id);
bool get_has_serialized();
void set_has_serialized(bool p_has_serialized);
