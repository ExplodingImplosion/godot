...
Array set_recent_frames(Array p_recent_frames);
RefCounted get_history();
RefCounted set_history(RefCounted p_history);
Node3d get_level();
Node3d set_level(Node3d p_level);
int get_recent_frame_idx();
int set_recent_frame_idx(int p_recent_frame_idx);
};
