...
ClassDB::bind_static_method("ThreadUtils", D_METHOD("add_thread", "callable", "high_priority", "description"), &ThreadUtils::add_thread);
...
ClassDB::bind_static_method("ThreadUtils", D_METHOD("add_locked_thread", "object", "callable", "high_priority", "description"), &ThreadUtils::add_locked_thread);
ClassDB::bind_static_method("ThreadUtils", D_METHOD("cleanup_locked_thread", "object", "clear"), &ThreadUtils::cleanup_locked_thread);
