...
String set_scene_path(String scene_path);
int get_u8_max_players();
int set_u8_max_players(int u8_max_players);
int get_u8_max_spectators();
int set_u8_max_spectators(int u8_max_spectators);
int get_u16_tickrate();
int set_u16_tickrate(int u16_tickrate);
};
