...
static int get_process_time_usec();
static void set_process_time_usec(int p_process_time_usec);
static int get_prev_process_time_usec();
static void set_prev_process_time_usec(int p_prev_process_time_usec);
static int get_process_delta_time_usec();
static void set_process_delta_time_usec(int p_process_delta_time_usec);
static float get_process_delta_time_float();
static void set_process_delta_time_float(float p_process_delta_time_float);
static int get_deferred_process_time_usec();
static void set_deferred_process_time_usec(int p_deferred_process_time_usec);
static int get_idle_process_time_usec();
static void set_idle_process_time_usec(int p_idle_process_time_usec);
static int get_physics_time_usec();
static void set_physics_time_usec(int p_physics_time_usec);
static int get_prev_physics_time_usec();
static void set_prev_physics_time_usec(int p_prev_physics_time_usec);
static int get_physics_delta_time_usec();
static void set_physics_delta_time_usec(int p_physics_delta_time_usec);
static int get_physics_start_time_usec();
static void set_physics_start_time_usec(int p_physics_start_time_usec);
static int get_deferred_physics_time_usec();
static void set_deferred_physics_time_usec(int p_deferred_physics_time_usec);
static int get_idle_physics_time_usec();
static void set_idle_physics_time_usec(int p_idle_physics_time_usec);
static float get_interpfrac();
static void set_interpfrac(float p_interpfrac);
static Thread get_time_thread();
static void set_time_thread(Thread p_time_thread);
static int get_current_time_thread();
static void set_current_time_thread(int p_current_time_thread);
static float get_last_time_thread();
static void set_last_time_thread(float p_last_time_thread);
static int get_delta_time_thread();
static void set_delta_time_thread(int p_delta_time_thread);
