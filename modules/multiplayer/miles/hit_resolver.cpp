...
Node3d HitResolver::set_mp_level(Node3d mp_level) {
	
}
Array HitResolver::get_hit_requests() {
	
}
Array HitResolver::set_hit_requests(Array hit_requests) {
	
}
Dictionary HitResolver::get_hit_map() {
	
}
Dictionary HitResolver::set_hit_map(Dictionary hit_map) {
