...
ADD_PROPERTY(PropertyInfo(Variant::DICTIONARY, "map", 38, "GDScript;RefCounted", 4096), "get_map," "set_map"); // unfinished and u should prolly change this
ADD_PROPERTY(PropertyInfo(Variant::ARRAY, "type_list", 31, "RefCounted", 4096), "get_type_list," "set_type_list"); // unfinished and u should prolly change this
