...
int get_u32_frame();
int set_u32_frame(int p_u32_frame);
int get_u32_last_frame();
int set_u32_last_frame(int p_u32_last_frame);
int get_u32_input_signature();
int set_u32_input_signature(int p_u32_input_signature);
int get_u32_acked_signature();
int set_u32_acked_signature(int p_u32_acked_signature);
PackedByteArray get_contents();
PackedByteArray set_contents(PackedByteArray p_contents);
};
