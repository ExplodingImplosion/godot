...
ADD_PROPERTY(PropertyInfo(Variant::STRING_NAME, "name"), "get_name," "set_name"); // unfinished and u should prolly change this
ADD_PROPERTY(PropertyInfo(Variant::INT, "type", 2, "Type Nil:0,Type Bool:1,Type Int:2,Type Float:3,Type String:4,Type Vector 2:5,Type Vector 2i:6,Type Rect 2:7,Type Rect 2i:8,Type Vector 3:9,Type Vector 3i:10,Type Transform 2d:11,Type Vector 4:12,Type Vector 4i:13,Type Plane:14,Type Quaternion:15,Type Aabb:16,Type Basis:17,Type Transform 3d:18,Type Projection:19,Type Color:20,Type String Name:21,Type Node Path:22,Type Rid:23,Type Object:24,Type Callable:25,Type Signal:26,Type Dictionary:27,Type Array:28,Type Packed Byte Array:29,Type Packed Int 32 Array:30,Type Packed Int 64 Array:31,Type Packed Float 32 Array:32,Type Packed Float 64 Array:33,Type Packed String Array:34,Type Packed Vector 2 Array:35,Type Packed Vector 3 Array:36,Type Packed Color Array:37,Type Packed Vector 4 Array:38,Type Max:39", 69638), "get_type," "set_type"); // unfinished and u should prolly change this
ADD_PROPERTY(PropertyInfo(Variant::INT, "precision_level", 2, "Default:0,Max:1,Half:2,Byte:3,U 32:4,U 64:5,U 16:6,U 8:7,Dynamic:8,U Dynamic:9,Enum:10", 69638), "get_precision_level," "set_precision_level"); // unfinished and u should prolly change this
ADD_PROPERTY(PropertyInfo(Variant::INT, "sub_property_index", 2, "None:-1,X:0,Y:1,Z:2,W:3", 69638), "get_sub_property_index," "set_sub_property_index"); // unfinished and u should prolly change this
ADD_PROPERTY(PropertyInfo(Variant::INT, "interp_type", 2, "Interpolate:0,Discrete Latest:1,Discrete Previous:2", 69638), "get_interp_type," "set_interp_type"); // unfinished and u should prolly change this
ADD_PROPERTY(PropertyInfo(Variant::INT, "visibility_type", 2, "All:0,Owner Only:1,Team Only:2,Vis Type Max:3", 69638), "get_visibility_type," "set_visibility_type"); // unfinished and u should prolly change this
ADD_PROPERTY(PropertyInfo(Variant::BOOL, "physical"), "get_physical," "set_physical"); // unfinished and u should prolly change this
ADD_PROPERTY(PropertyInfo(Variant::BOOL, "rotation"), "get_rotation," "set_rotation"); // unfinished and u should prolly change this
ADD_PROPERTY(PropertyInfo(Variant::BOOL, "recent_only"), "get_recent_only," "set_recent_only"); // unfinished and u should prolly change this
ADD_PROPERTY(PropertyInfo(Variant::INT, "network_type"), "get_network_type," "set_network_type"); // unfinished and u should prolly change this
ADD_PROPERTY(PropertyInfo(Variant::INT, "max_bits"), "get_max_bits," "set_max_bits"); // unfinished and u should prolly change this
ADD_PROPERTY(PropertyInfo(Variant::INT, "size_bytes"), "get_size_bytes," "set_size_bytes"); // unfinished and u should prolly change this
ADD_PROPERTY(PropertyInfo(Variant::INT, "encode_type"), "get_encode_type," "set_encode_type"); // unfinished and u should prolly change this
ADD_PROPERTY(PropertyInfo(Variant::OBJECT, "value_type", 17, "Property", 4102), "get_value_type," "set_value_type"); // unfinished and u should prolly change this
ADD_PROPERTY(PropertyInfo(Variant::OBJECT, "key_type", 17, "Property", 4102), "get_key_type," "set_key_type"); // unfinished and u should prolly change this
