...
int ChangeTeamRequestPacket::set_u8_player_index(int u8_player_index) {
...
ClassDB::bind_method(D_METHOD("is_script_valid_packet", "script"), &ChangeTeamRequestPacket::is_script_valid_packet);
ClassDB::bind_method(D_METHOD("_execute", "_sender_id"), &ChangeTeamRequestPacket::_execute);
ADD_PROPERTY(PropertyInfo(Variant::INT, "u8_player_index" , "get_u8_player_index", "set_u8_player_index")); // unfinished and u should prolly change this
}